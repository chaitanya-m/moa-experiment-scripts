...
#----------
    ...
    new_col_names = ["0:HAT", "1:HATErrorRedist"]
...
def runMultiStreamExpML(title, learners, generators, evaluators, suffix, num_streams=num_streams_to_average):
    ...
    new_col_names = ["HAT", "EFDT", "EFDTBoost", "HATErrorRedist"]
    all_processes=[]
...
def chart10():
    ...
    evaluators = [r"EvaluatePrequential -i 400000 -f 1000 -q 1000"]
    #runexp(learners, generators, evaluators, 3)
    runMultiStreamExpML("HAT vs HATErrorRedist: No Drift", learners, generators, evaluators, str(10))
...
def chart11():
    ...
    evaluators = [r"EvaluatePrequential -i 400000 -f 1000 -q 1000"]
    #runexp(learners, generators, evaluators, 3)
    runMultiStreamExpML("HAT vs HATErrorRedist: Abrupt Drift", learners, generators, evaluators, str(11))
...
def chart12():
    ...
    evaluators = [r"EvaluatePrequential -i 1000000 -f 1000 -q 1000"]
    #runexp(learners, generators, evaluators, 3)
    runMultiStreamExpML("HAT vs HATErrorRedist: No Drift", learners, generators, evaluators, str(12))
...
def chart13():
    ...
    evaluators = [r"EvaluatePrequential -i 1000000 -f 1000 -q 1000"]
    #runexp(learners, generators, evaluators, 3)
    runMultiStreamExpML("HAT vs HATErrorRedist: No Drift", learners, generators, evaluators, str(13))
...
def chart14():
    ...
    evaluators = [r"EvaluatePrequential -i 1000000 -f 1000 -q 1000"]
    #runexp(learners, generators, evaluators, 3)
    runMultiStreamExpML("HAT vs HATErrorRedist: No Drift", learners, generators, evaluators, str(14))
...
def chart15():
    ...
    evaluators = [r"EvaluatePrequential -i 1000000 -f 1000 -q 1000"]
    #runexp(learners, generators, evaluators, 3)
    runMultiStreamExpML("HAT vs HATErrorRedist: No Drift", learners, generators, evaluators, str(15))
...
def chart16():
    ...
    evaluators = [r"EvaluatePrequential -i 1000000 -f 1000 -q 1000"]
    #runexp(learners, generators, evaluators, 3)
    runMultiStreamExpML("HAT vs HATErrorRedist: No Drift", learners, generators, evaluators, str(16))
...
def chart17():
    ...
    evaluators = [r"EvaluatePrequential -i 1000000 -f 1000 -q 1000"]
    #runexp(learners, generators, evaluators, 3)
    runMultiStreamExpML("HAT vs HATErrorRedist: No Drift", learners, generators, evaluators, str(17))
...
def chart18():
    ...
    evaluators = [r"EvaluatePrequential -i 1000000 -f 1000 -q 1000"]
    #runexp(learners, generators, evaluators, 3)
    runMultiStreamExpML("HAT vs HATErrorRedist: No Drift", learners, generators, evaluators, str(18))
...
def chart19():
    ...
    evaluators = [r"EvaluatePrequential -i 1000000 -f 1000 -q 1000"]
    #runexp(learners, generators, evaluators, 3)
    runMultiStreamExpML("HAT vs HATErrorRedist: No Drift", learners, generators, evaluators, str(19))
...
def chart20():
    ...
    evaluators = [r"EvaluatePrequential -i 1000000 -f 1000 -q 1000"]
    #runexp(learners, generators, evaluators, 3)
    runMultiStreamExpML("HAT vs HATErrorRedist: No Drift", learners, generators, evaluators, str(20))
...
def chart21():
    ...
    evaluators = [r"EvaluatePrequential -i 1000000 -f 1000 -q 1000"]
    #runexp(learners, generators, evaluators, 3)
    runMultiStreamExpML("HAT vs HATErrorRedist: No Drift", learners, generators, evaluators, str(21))
...
def chart22():
    ...
    evaluators = [r"EvaluatePrequential -i 1000000 -f 1000 -q 1000"]
    #runexp(learners, generators, evaluators, 3)
    runMultiStreamExpML("HAT vs HATErrorRedist: No Drift", learners, generators, evaluators, str(22))
...
def chart23():
    ...
    evaluators = [r"EvaluatePrequential -i 1000000 -f 1000 -q 1000"]
    #runexp(learners, generators, evaluators, 3)
    runMultiStreamExpML("HAT vs HATErrorRedist: Recurrent Drift", learners, generators, evaluators, str(23))
...
def chart23a():
    ...
    evaluators = [r"EvaluatePrequential -i 1000000 -f 1000 -q 1000"]
    #runexp(learners, generators, evaluators, 3)
    runMultiStreamExpML("HAT vs HATErrorRedist: Recurrent Drift", learners, generators, evaluators, str('23a'))
...
def chart24():
    ...
    #runexp(learners, generators, evaluators, 3)
    runMultiStreamExpML("HAT vs HATErrorRedist: Gradual Drift", learners, generators, evaluators, str(24))
...
def chart24a():
    ...
    evaluators = [r"EvaluatePrequential -i 1000000 -f 1000 -q 1000"]
    #runexp(learners, generators, evaluators, 3)
    runMultiStreamExpML("HAT vs HATErrorRedist: Gradual Drift", learners, generators, evaluators, str('24a'))
...
def chart25():
    ...
    evaluators = [r"EvaluatePrequential -i 1000000 -f 1000 -q 1000"]
    #runexp(learners, generators, evaluators, 3)
    runMultiStreamExpML("HAT vs HATErrorRedist: Abrupt Drift", learners, generators, evaluators, str(25))
...
def chart25a():
    ...
    evaluators = [r"EvaluatePrequential -i 1000000 -f 1000 -q 1000"]
    #runexp(learners, generators, evaluators, 3)
    runMultiStreamExpML("HAT vs HATErrorRedist: Abrupt Drift", learners, generators, evaluators, str('25a'))
...
def chart25b():
    ...
    evaluators = [r"EvaluatePrequential -i 1000000 -f 1000 -q 1000"]
    #runexp(learners, generators, evaluators, 3)
    runMultiStreamExpML("HAT vs HATErrorRedist: No Drift", learners, generators, evaluators, str('25b'))
...
def chart30a():
    ...
    evaluators = [r"EvaluatePrequential -i 400000 -f 1000 -q 1000"]
    #runexp(learners, generators, evaluators, 3)
    runMultiStreamExpML("HAT, EFDT, EFDTBoost, HATErrorRedist: Abrupt Drift", learners, generators, evaluators, str('30a'))
...
def chart30g():
    ...
    evaluators = [r"EvaluatePrequential -i 400000 -f 1000 -q 1000"]
    #runexp(learners, generators, evaluators, 3)
    runMultiStreamExpML("HAT, EFDT, EFDTBoost, HATErrorRedist: Gradual Drift", learners, generators, evaluators, str('30g'))
...
def chart30r():
    ...
    evaluators = [r"EvaluatePrequential -i 400000 -f 1000 -q 1000"]
    #runexp(learners, generators, evaluators, 3)
    runMultiStreamExpML("HAT,EFDT, EFDTBoost, HATErrorRedist: Recurrent Drift", learners, generators, evaluators, str('30r'))
...
def chart30():
    ...
    evaluators = [r"EvaluatePrequential -i 400000 -f 1000 -q 1000"]
    #runexp(learners, generators, evaluators, 3)
    runMultiStreamExpML("HAT, EFDT, EFDTBoost, HATErrorRedist: No Drift", learners, generators, evaluators, str('30'))
