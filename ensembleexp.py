...
def chart24():
    ...
    lmetaEFDTNoRevision = [ 
            r"-l (meta.OzaBag -l (trees.EFDT -R 1410065407))",
            r"-l (meta.OzaBagAdwin -l (trees.EFDT -R 1410065407))",
            r"-l (meta.LeveragingBag -l (trees.EFDT -R 1410065407))",
            r"-l (meta.LevBagNoAdwin -l (trees.EFDT -R 1410065407))",
            r"-l (meta.OzaBoost -l (trees.EFDT -R 1410065407))",
            r"-l (meta.OzaBoostAdwin -l (trees.EFDT -R 1410065407))",
            r"-l (meta.AdaptableDiversityBasedOnlineBoosting -l (trees.EFDT -R 1410065407))",
            r"-l (meta.BOLE -l (trees.EFDT -R 1410065407))",
            r"-l (meta.OnlineSmoothBoost -l (trees.EFDT -R 1410065407))",
            r"-l (meta.ARF -l (ARFEFDT -R 1410065407))",
            r"-l (meta.ARF -l (ARFEFDT -R 1410065407 -g 200 -c 0.0000001) -o (Percentage (M * (m / 100))) -m 80 -q)",
            #disables EFDT rechecking unless you have over 1.4 billion instances
		      ]
